...
RESULTS_ROOT = Path(
    os.environ.get(
        "ASTRID_V21_RESULTS",
        "/data/BLUSA_002_S_ROSA_FRONT_V2/models/patchcore_v21_baseline_512",
    )
)
...
def main():
    print("=" * 72)
    print("PATCHCORE V2.1 - EXPERIMENTO 512x512")
    print("=" * 72)
    ...
    datamodule = Folder(
        name="BLUSA_002_S_ROSA_FRONT_V21_BASELINE_512",
        root=DATA_ROOT,
    ...
    print()
    print("=" * 72)
    print("ENTRENAMIENTO V2.1 FINALIZADO")
    print("=" * 72)
    print(f"Resultados: {RESULTS_ROOT}")
