...
RESULTS_ROOT = Path(
    os.environ.get(
        "ASTRID_V21_RESULTS",
        "/data/BLUSA_002_S_ROSA_FRONT_V2/models/patchcore_v22_ar_352x512",
    )
)
...
def main():
    print("=" * 72)
    print("PATCHCORE V2.2 - ASPECT RATIO 352x512")
    print("=" * 72)
    ...
    print("  image_size: 352x512 (H x W)")
    ...
    datamodule = Folder(
        name="BLUSA_002_S_ROSA_FRONT_V22_AR_352X512",
        root=DATA_ROOT,
    ...
    print("=" * 72)
    print("INICIANDO FIT V2.2 AR 352x512")
    print("=" * 72)
    ...
    print()
    print("=" * 72)
    print("ENTRENAMIENTO V2.2 AR 352x512 FINALIZADO")
    print("=" * 72)
    print(f"Resultados: {RESULTS_ROOT}")
